 ...
 * @author	http://www.openfox.com
 * @license	GNU General Public License
 * @copyright(C) 2017  Openfox. All rights reserved.
*******************************************************/
?>
...
<div class="container product-detail">
    ...
    <div id="content" class="col-xs-12">
		...
		*/			
				//$proImage = 'http://ektry.com/image/cache/'.$product_image.'-400x400';
				$ext = pathinfo($product_image, PATHINFO_EXTENSION);
				$name = substr($product_image, 0,strlen($product_image)-4);
				$proImage = 'http://ektry.com/image/cache/'.$name.'-400x400.'.$ext;
			?>
				...
				<div class="content-product-left ">
					<div class="slider-for" >
							<div class="contentslider--item">
									...
									<img src="<?php echo $proImage; ?>" title="<?php // echo $heading_title; ?>" alt="<?php //echo $heading_title; ?>" />
							</div>
					</div>
				</div>
